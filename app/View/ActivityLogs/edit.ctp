...
<?php echo $this->Form->create('ActivityLog');?>
	<fieldset>
		<legend><?php echo __('Edit Activity Log'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ActivityLog.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ActivityLog.id'))); ?></li>
